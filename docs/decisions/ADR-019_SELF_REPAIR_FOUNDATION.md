...
**PROPOSED — OWNER ARCHITECTURE APPROVAL REQUIRED**
...
### 12. Source repair remains isolated and review-gated
...
Revisit this ADR after deterministic R1/R2 repairs are production-accepted, when introducing AI-assisted diagnostics or R4 source-repair proposals.
