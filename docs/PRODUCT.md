...
| CAP-008 | Live Session Context | Active task, goal, project, recent outcomes/issues/pending work. | 4 | ACTIVE |
| CAP-009 | Long-Term Personal Memory | Durable useful personal/project facts with provenance and correction. | 4 | ACTIVE |
| CAP-010 | Episodic Memory | Recall meaningful past events, sessions, failures, fixes, milestones. | 4 | ACTIVE |
| CAP-011 | Semantic Memory | Durable facts/preferences/rules with conflict and supersession handling. | 4 | ACTIVE |
| CAP-012 | Reflection and Session Learning | Achievements, issues, decisions, next steps, memory candidates. | 4 | ACTIVE |
| CAP-013 | Emotional Interaction Context | Transient interaction signals that improve tone without becoming permanent identity facts. | 4 | ACTIVE |
...
| CAP-034 | Authority, Permissions, and Consent | Decide whether reads/writes/external/destructive actions are permitted. | 3 | DONE |
...
| ID | Capability | Purpose | Step | Status |
| --- | --- | --- | ---: | --- |
| CAP-037 | Runtime Observability | Trace sessions, turns, latency, provider/capability results, authority decisions safely. | 3 | DONE |
