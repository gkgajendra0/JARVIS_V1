...
class RFDetrNanoConfig:
    device: str = "cuda"
    # ByteTrack is designed to recover established tracks from low-confidence
    # detections. Keep detector recall broad and let the tracker decide whether a
    # candidate may recover an existing track or create a new one.
