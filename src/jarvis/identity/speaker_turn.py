...
class InMemorySpeakerTurnCapture:
    ...
    def push_frame(
        ...
        *,
        ...
        self._pre_roll.append((payload, samples_per_channel))
        ...
        while self._pre_roll and self._pre_roll_samples > limit:
            _, removed_samples = self._pre_roll.popleft()
    ...
    def start_turn(self) -> None:
        ...
        self._turn_chunks = [payload for payload, _ in self._pre_roll]
    ...
    def finish_turn(self) -> SpeakerTurnAudio | None:
        ...
        if samples.size == 0:
            return None
        return SpeakerTurnAudio(samples=samples, sample_rate=sample_rate)
