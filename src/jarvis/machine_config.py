...
PERSISTABLE_SETTINGS = frozenset(
    {
        ...
        "JARVIS_VISUAL_COMPUTER_USE_ENABLED",
        ...
        "JARVIS_POCKET3_BLE_NAME",
        "JARVIS_POCKET3_OWNER_EVIDENCE_MAX_AGE_SECONDS",
        "JARVIS_POCKET3_SUBJECT_PUSH_STALE_SECONDS",
        "JARVIS_POCKET3_LOCK_PENDING_TIMEOUT_SECONDS",
        "JARVIS_POCKET3_RESEND_COOLDOWN_SECONDS",
        "JARVIS_OWNER_WORKSTATION_LOCK_ENABLED",
        "JARVIS_OWNER_WORKSTATION_LOCK_DELAY_SECONDS",
        "JARVIS_OPA_PATH",
        "JARVIS_WINDOWS_HELLO_HELPER",
    }
)
